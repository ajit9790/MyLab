...
resource "aws_instance" "AnsibleController" {
  ...
  tags = {
    Name = "Ansible-Controll-Node"
  }
} 
# creat an instance for ansible and tomcat
...
# creat an instance for Nexus repo
